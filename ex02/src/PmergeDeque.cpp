...
/*   Updated: 2025/08/02 17:02:10 by tsofien-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// ========================================================================
PmergeDeque::PmergeDeque(int ac, char **av)
{
	if (ac < 2)
	{
...
PmergeDeque::PmergeDeque(const PmergeDeque &src)
{
	if (this != &src)
	{
...
bool PmergeDeque::isDigit(const std::string &str) const
{
	if (str.empty())
		return false;
...
bool PmergeDeque::isValidInt(const std::string &str) const
{
...
bool PmergeDeque::is_sort(std::deque<int> &vec)
{
...
size_t PmergeDeque::createPairDeques()
{
...
void PmergeDeque::makePairDeques(std::deque<PairDeque> &PairDeques, size_t PairDequeSize)
{
	PairDeques.clear();
	size_t size = _numbers.size();
	if (PairDequeSize < 1)
...
void PmergeDeque::recursivePairDeques(std::deque<PairDeque> &PairDeques, size_t PairDequeSize)
{
	if (PairDequeSize < 1)
		return;
...
void PmergeDeque::insert_PairDeque(std::deque<PairDeque> &main, const PairDeque &element, int search_limit)
{
...
size_t PmergeDeque::find_partner_position(const PairDeque &pend_element)
{
...
bool PmergeDeque::compare_PairDeques(const PairDeque &a, const PairDeque &b)
{
	return a.pairDeque.back() < b.pairDeque.back();
}

int PmergeDeque::jacobstahl_numbers(int n)
{
	if (n == 0)
		return 0;
	if (n == 1)
...
void PmergeDeque::displayNumbers() const
{
...
void PmergeDeque::displayRest() const
{
...
void PmergeDeque::displayMain() const
{
	if (_main.empty())
	{
...
void PmergeDeque::displayPend() const
{
	if (_pend.empty())
	{
...
void PmergeDeque::displayPairDeque(const std::deque<PairDeque> &PairDeques) const
{
...
std::deque<int> PmergeDeque::getNumbers() const
{
	return _numbers;
}